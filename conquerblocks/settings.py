...
SECRET_KEY = 'django-insecure-dfjwc7-vk-)a2f64+j*lfk)^!hy=!l3whg+v2#!6j9r+rww$um'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "conquerblocks" / "templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT=587
EMAIL_USE_TLS=True
EMAIL_HOST_USER='mendozagonzalez.irene@gmail.com'
EMAIL_HOST_PASSWORD= 'rcoa usis zvdi tcza'
